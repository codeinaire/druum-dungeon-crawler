...
**Status:** plan-approval pending (pipeline scope = research → plan → STOP per orchestrator brief)
**Last Completed Step:** 2 (plan written; awaiting user decisions D1–D7 before parent dispatches implementer)
...
| 3    | Implement   | NOT IN SCOPE — pipeline stops at plan-approval |
| 4    | Ship        | NOT IN SCOPE                             |
